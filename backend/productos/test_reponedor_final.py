"""
Test para la funcionalidad de productos del reponedor
...
class BaseReponedorTestCase(TestCase):
    ...
    def setup_base_data(self):
        ...
        # Autenticar como reponedor
        refresh = RefreshToken.for_user(self.repo_user)
...
class ProductoReponedorAPITestCase(BaseReponedorTestCase):
    ...
    def test_reponedor_crear_producto_nuevo(self):
        ...
        data = {
            ...
            'activo': True,
            'cantidad': 50  # Para el stock inicial
        }
    ...
    def test_reponedor_deposito_automatico_asignado(self):
        ...
        # Verificar que el reponedor tiene asignado el depósito correcto
        # url = reverse('empleados-me')  # Endpoint para obtener info del empleado actual
        # response = self.client.get(url)
        
        # Verificar directamente desde el modelo ya que no hay endpoint
...
class ProductoStockAPITestCase(BaseReponedorTestCase):
    ...
    def test_gestionar_stock_producto_post(self):
        ...
        # Crear stock inicial
        # url = reverse('producto-deposito-list')  # Endpoint para gestión de stock
        data = {
        ...
        # Crear directamente para verificar funcionalidad
        producto_deposito = ProductoDeposito.objects.create(
            producto=producto,
            deposito=self.deposito,
            cantidad=40,
