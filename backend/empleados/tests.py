...
class EmpleadoURLSTestCase(TestCase):
    """Tests para las URLs de empleados"""
    ...
    def test_urls_existen(self):
        """Test: Verificar que las URLs necesarias existen"""
        # URL para listar y crear empleados
        try:
            url = reverse('empleados:empleado-list-create')
            self.assertIsNotNone(url)
        except:
            self.fail("URL 'empleados:empleado-list-create' no existe")
        
        # URL para detalle de empleado
        try:
            url = reverse('empleados:empleado-detail', kwargs={'pk': self.empleado.pk})
            self.assertIsNotNone(url)
        except:
            self.fail("URL 'empleados:empleado-detail' no existe")
        
        # URL para roles disponibles
        try:
            url = reverse('empleados:roles-disponibles')
            self.assertIsNotNone(url)
        except:
            self.fail("URL 'empleados:roles-disponibles' no existe")
